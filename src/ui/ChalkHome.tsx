      ...
      <div className="ck-board">
        ...
        <div className="ck-body">
          ...
          >
            ...
            {/* the six men, on the floor and UNDER the marks, so no head ever covers an O or a
                name — and then the ball, in its own layer OVER them, because a ball in the air
