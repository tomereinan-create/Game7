...
const RULE: Record<string, string> = {
  ...
  Microwave: 'High usage, high efficiency, no playmaking — instant offense off the bench.',
  ...
  'Elite role player': 'Low usage, shoots at 75+, defends at 80+, passes — and can actually play (OFF 72+). The fifth starter every contender wants.',
  ...
  Connector: 'Low usage, shoots, passes, defends. The fifth man who makes it work.',
  'Secondary creator': 'Real playmaking at real usage, below a lead handler’s share.',
