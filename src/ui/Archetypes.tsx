...
const RULE: Record<string, string> = {
  'Defensive playmaker': 'He runs the offense and takes the other team’s best perimeter man, and the shot is somebody else’s job. Two demanding roles at once, neither of them scoring.',
  'Point god': 'The finest passer in the game, in a guard’s body, and he does not need his own shot to do it. Everything the offense does begins with him.',
  ...
  'Triple-double threat': 'He fills every column at once — creating, rebounding and scoring. Any size: a centre who runs the offense qualifies.',
  'Versatile defender': 'He guards several positions, honest on the perimeter and honest at the rim, without being elite at either. Switchable, in a word.',
  ...
  'Floor general': 'A lead creator who sets the table and does not eat from it. The point god above him does the same job, from a guard’s body and at an even higher rate.',
  ...
  Unicorn: 'A seven-foot-two man who protects the rim and shoots from range. The size says centre and the game says otherwise.',
  'Two-way star': 'Elite at both ends. There are not many.',
  'Two-way guard': 'A guard who genuinely guards, passes like a second handler, and scores well without being the reason you watch. The smallest man on the two-way list and the most specific of its claims.',
  'All-around star': 'A star who scores, passes and holds up defensively — good everywhere, elite nowhere. Elite at both ends is the two-way star above him.',
  ...
  'Elite defender': 'The mirror of the offensive superstar: you play him for what he stops, and you live with the rest.',
  'Two-way big': 'A big whose defense carries him, with an offense that is real and secondary. Better defensively and he is an anchor or an elite defender; better with the ball and he is a two-way star.',
  ...
  'Volume shooter': 'He takes everything and converts little, and he is not the one setting the table. Somebody has to shoot, and on his team it is him.',
  'Scoring machine': 'He scores in enormous quantity from one elite spot, converting respectably rather than spectacularly, and somebody else creates it. Points are the contribution.',
  Scorer: 'Putting it in the basket is the whole of it, and no sharper diet described him. Not a creator: the offense does not run through him.',
  ...
  'Midrange maestro': 'He shoots a great deal, and his game lives entirely between the paint and the arc. He does not need a three to hurt you.',
  Slasher: 'A perimeter player who lives at the rim and gets to the line, with no three to speak of. He beats you off the bounce, never off the catch.',
  ...
  'Freight train': 'A forward with no jumper who scores at the rim anyway, because he is stronger than whoever is standing in it. He goes through you.',
  ...
  'Spark plug': 'A small guard who starts shooting the moment he touches the floor, without being a star. Instant offense, for better and for worse.',
  ...
  Deadeye: 'A pure stroke on a small load, from range and from the line. He is not asked to create the shot, only to make it.',
  'Catch-and-shoot wing': 'A wing who spaces the floor and shoots what he is given. He creates nothing, and needs nothing created for him beyond the pass.',
  'Stretch big': 'A big man who shoots from range. A wing who shoots is just a wing — the size is what makes it a problem.',
  'All-around big': 'The complete big man: he scores at the rim, carries a jumper, and cleans the defensive glass. There is no half of the frontcourt job he cannot do.',
  ...
  'Elite role player': 'The fifth starter every contender wants: he shoots, he defends, and he moves the ball without ever dominating it. What separates him from the plain three-and-D man is that he is genuinely good at BOTH ends, not merely useful at each.',
  Stopper: 'He takes the other team’s best perimeter scorer and removes him from the game, and offers nothing back — not even a shot you have to respect.',
  Pest: 'A little guard who is a menace on the ball. He picks pockets and lives in the passing lanes.',
  'Combo guard': 'A guard who does some creating and some scoring, neither at a lead man’s rate. Every rotation has one, and no single diet describes him.',
  Throwback: 'A midrange game and no three at all. He would have been at home in an earlier decade.',
  'Post scorer': 'A big who scores with his back to the basket and from the elbow, with no three and no passing game. The old frontcourt job, done the old way.',
  'Co-star': 'The second star: a real offensive player who holds up defensively, with no claim at either end sharp enough to earn a name above this one. Somebody’s second-best player.',
  'Glue guy': 'He scores a little, passes a little, defends, rebounds and takes care of the ball — above average at everything and elite at nothing. Every rule above this one names a strength; this one names a man who has none.',
  'All-around': 'Solid at several things with no single part of his game that stands above the rest. The glue guy above him is the same shape drawn tighter, on a smaller load.',
  Balanced: 'No rule in the tree matched him: nothing about his game is distinctive enough to name. For a role player that is simply the truth.',
  Unclassified: 'A good player the tree has no name for. He is not softened into the nearest fit — each one is a missing rule, and `npm run unfit` prints the list with the rule each man came closest to.',
}
