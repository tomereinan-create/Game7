...
const RULE: Record<string, string> = {
  ...
  'All-around star': 'Eighty and up on offense, holding up at 75 on defense, passing enough to be part of the offence (playmaking volume 40+), and an OVR of 82 — an actual star. Not elite at either end; that is the two-way star above him.',
