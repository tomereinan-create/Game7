...
export const RULE: Record<string, string> = {
  ...
  'Two-way shooter': 'A guard or a wing in the league’s top quarter at guarding the perimeter and at shooting the three. He takes a tough cover and spaces the floor on the way back.',
  'Lockdown defender': 'Perimeter defense is the best thing on his sheet, and it is among the best in the league. He takes the toughest cover on the floor and makes a night’s work of it.',
  'Rim protector': 'Defending the basket is what he is known for. Shots at the rim get harder the moment he checks in.',
  'Table setter': 'The offense runs through his passing, and the shots he creates belong to other people. He brings it up, gets everybody into their spots and keeps it moving.',
  'Lead guard': 'A creator who also looks for his own. The ball is in his hands, the passing is what he does best, and a real share of the scoring is his as well.',
  'Go-to scorer': 'Carrying the scoring load is what he does best. When his team needs a basket the ball goes to him, and everybody in the building knows it.',
  'Midrange scorer': 'His game lives between the paint and the arc. He gets to his spot, rises, and takes the two.',
  'Interior scorer': 'A big who scores at the basket — on the block, on the roll and on the glass. Finishing inside is the best thing he does.',
  'Rim attacker': 'A perimeter player whose best skill is finishing at the rim. He puts the ball on the floor, gets downhill and gets all the way there.',
  'Spot-up shooter': 'The three is his signature, on a light load. He stands where the offense needs him and makes the shot the pass creates.',
  'Scoring shooter': 'The three is his signature, and he carries real scoring volume with it. He comes off screens firing and the defense chases him all night.',
  'Shooting big': 'A big whose jumper is the best thing on his sheet. He sets the screen, steps out to the elbow or the arc, and makes the shot.',
