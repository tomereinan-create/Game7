...
export const RULE: Record<string, string> = {
  ...
  'Defensive specialist': 'Perimeter defense is the best thing on his sheet. He checks in to guard somebody, takes the tough cover, and asks for nothing at the other end.',
  'Shot blocker': 'Defending the basket is why he plays. Shots at the rim get harder the moment he checks in.',
  'Pass-first playmaker': 'His passing is the best thing he does and the shots he creates belong to other people. He gets everybody into their spots and keeps it moving.',
  'Ball-dominant guard': 'The ball is in his hands. Passing is what he does best, and he takes a real share of the shots as well.',
  'Microwave scorer': 'Getting shots up is what he does best, and enough of them go in. He checks in and the scoring starts.',
  'Gunner': 'He takes a lot of shots and too few of them fall. The load is real; the conversion is not.',
  'Midrange specialist': 'His game lives between the paint and the arc. He gets to his spot, rises, and takes the two.',
  'Paint scorer': 'A big whose points come at the basket — on the block, on the roll and on the glass. Finishing inside is the best thing he does.',
  ...
  'Perimeter scorer': 'The three is his best weapon and he gets his shots up. He comes off screens firing and somebody has to chase him.',
